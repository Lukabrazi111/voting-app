        ...
        <div class="flex flex-1 px-4 py-6">
            ...
            <div class="w-full mx-4">
                ...
                <div class="text-gray-600 mt-3">
                    ...
                    adipisicing elit. Ad aspernatur, atque natus possimus quae quas sequi tempore? Eveniet ex expedita
                    ipsam modi, molestias mollitia neque nisi officiis ratione velit voluptate.
                </div>
                    ...
                    <div
                        ...
                        <button
                            ...
                            <ul
                                ...
                                class="absolute w-44 text-left font-semibold bg-white shadow-dialog rounded-xl py-3 top-5 ml-6">
                                <li>
                                    <a href="#"
        ...
        <div class="flex items-center space-x-4 ml-6">
            <div
                ...
                <button
                    @click="isOpen = !isOpen"
                    type="button"
                    class="flex items-center justify-center w-36 h-11 text-sm bg-blue text-white font-semibold
                ...
                <div
                    ...
                    <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex items-center space-x-3">
                            <button
                                type="button"
                                class="flex items-center justify-center w-1/2 h-11 text-sm bg-blue text-white font-semibold
                                    rounded-xl border border-blue hover:bg-blue-hover
                                     transition duration-150 ease-in px-6 py-3"
                            >
                                Post Comment
                        ...
                        <div class="space-y-2">
                            <div>
                                <label for="" class="inline-flex items-center">
                                    <input type="radio" checked="" class="text-gray-600 bg-gray-200 border-none"
